...
export const Callback: FC<CallbackProps> = ({ background, className, specificClass = 'page' }) => {
    ...
    <div className={classes}>
      <div className={cn(style.inner, className)}>
        <div className={style.heading}>
          <Title accent='mint'>Остались <span>вопросы?</span></Title>
          <Text>Оставьте свои контакты и мы свяжемся с вами, чтобы помочь в выборе оптимального тарифа</Text>
        </div>
